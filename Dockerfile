...
RUN apt update && apt -y install apt-transport-https ca-certificates curl gnupg2 software-properties-common make python3-pip && \
...
RUN pip3 install pip --upgrade && pip3 install docker-compose
